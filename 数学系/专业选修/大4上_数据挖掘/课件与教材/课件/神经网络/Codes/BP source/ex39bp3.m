%function main()
  ...
  W1=0.2*rand(HiddenUnitNum1,InDim) - 0.1;
  B1=0.2*rand(HiddenUnitNum1,1) - 0.1;
  W2=0.2*rand(HiddenUnitNum2,HiddenUnitNum1) - 0.1;
  B2=0.2*rand(HiddenUnitNum2,1) - 0.1;
  W3=0.2*rand(OutDim,HiddenUnitNum2) - 0.1;
  ...
  for i=1:MaxEpochs
      %forward 
      HiddenOut1=logsig(W1Ex*SamInEx);
      HiddenOutEx1=[HiddenOut1' ones(SamNum,1)]';
      HiddenOut2=logsig
